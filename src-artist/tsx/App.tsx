...
export const App = () => {
	...
	return (
		<span>
			<iframe title="YouTube video player" allow="autoplay; encrypted-media;" ref={iframe} />
			<main>
			<header>
				<h3>€CHO€D 4W4Y</h3>
			</header>
			<a href="https://open.spotify.com/artist/5MaazmzZIHqs5sdA0jmtV2">Spotify</a>
			<br/>
			<a href="https://music.apple.com/au/artist/%E2%82%ACcho%E2%82%ACd-4w4y/1780938599">Apple Music</a>
			<br/>
