  ...
  return (
    <>
      ...
      <Popover id="audio" title="Music & Audio">
        ...
        <br />I have a FiiO <Link href="https://www.fiio.com/k3s">
          K3S
        </Link>{" "}
      ...
      <Popover id="smarthome" title="Smart Home Equipment">
        ...
        <Link href="https://csa-iot.org/all-solutions/matter">
          Matter
        </Link> over <Link href="https://threadgroup.org">Thread</Link>{" "}
        ecosystem, and refuse to use pretty much anything else
